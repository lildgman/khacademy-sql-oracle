/*
    ...
    캐시메모리: 미리 발생될 값들을 생성해서 저장해두는 공간
            매번 호출될 때마다 새로 번호를 생성하는게 아닌
            캐시메모리 공간에 미리 생성된 값들을 가져다 쓸 수 있게 해둔다.
            (속도가 빨라진다.)
...
--> CURRVAL은 마지막을 성공한 NEXTVAL의 값을 저장해서 보여주는 임시값이기 때문
...
VALUES (SEQ_EID.NEXTVAL, '김모씨','111111-1111111','J7',SYSDATE);

INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
VALUES (SEQ_EID.NEXTVAL, '박모씨','111122-1111111','J7',SYSDATE);
