...
create table tb_member(
	...
	enroll_date date default now() constraint MEMBER_NN_EN NOT null
);
...
values (1,'user1','pwd1','username1','M','서울시 ~','010-1111-2222','N'),
	(2,'user2','pwd2','username2','F','경기도 ~','010-3333-4444','N'),
	(3,'user3','pwd3','username3','F','서울시 ~','010-4444-5555','N'),
	(4,'user4','pwd4','username4','M','서울시 ~','010-5555-6666','Y'),
	(5,'user5','pwd5','username5','M','서울시 ~','010-7777-8888','N');
